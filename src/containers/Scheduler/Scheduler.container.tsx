...
const getResources = (
  ...
  resources.push({
    ...
    instances: [
      ...
      { id: LessonFlags.Practice, text: 'Практика', color: yellow },
      { id: LessonFlags.Event, text: 'Событие', color: teal },
      { id: LessonFlags.MilitaryTraining, text: 'ВУЦ', color: green },
      { id: LessonFlags.PhysicalTraining, text: 'Физ.культура', color: yellow },
      { id: LessonFlags.Elective, text: 'Факультатив', color: blue },
      { id: LessonFlags.External, text: 'Внешнее занятие', color: teal },
      { id: LessonFlags.Tenzor, text: 'Тензор', color: blue },
      { id: LessonFlags.School21, text: 'Школа 21', color: yellow },
