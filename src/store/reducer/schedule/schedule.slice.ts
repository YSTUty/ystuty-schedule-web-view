...
export const DEFAULT_ALLOW_MULTIPLE_TEACHERS = !!store2.get(
  STORE_ALLOW_MULTIPLE_TEACHERS_KEY,
  false,
);
export const DEFAULT_ALLOW_MULTIPLE_AUDIENCES = !!store2.get(
