...
export const getLessonColor = (type: LessonFlags) => {
  switch (type) {
    ...
    case type & LessonFlags.Practice:
    case type & LessonFlags.PhysicalTraining:
    case type & LessonFlags.School21:
      return yellow;
    case type & LessonFlags.Event:
    case type & LessonFlags.External:
      return teal;
    case type & LessonFlags.MilitaryTraining:
      return green;
    case type & LessonFlags.Elective:
    case type & LessonFlags.Tenzor:
      return blue;
